...
<html class=" js canvas canvastext geolocation crosswindowmessaging no-websqldatabase indexeddb hashchange historymanagement draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow opacity cssanimations csscolumns cssgradients no-cssreflections csstransforms no-csstransforms3d csstransitions  video audio localstorage sessionstorage webworkers applicationcache svg smil svgclippaths   fontface">
    ...
    <body onload="doOnLoad();" class="hold-transition skin-blue sidebar-mini fixed">    
            ...
            <div class="modal-dialog modal-lg"  style="width:1000px;">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #00aae7;height:50px;">
                        ...
                        <h4 class="modal-title" style="color:white;text-align: center;">Top 10 EDI Trading partners</h4>
                    </div>
        ...
        <div class="modal fade" id="top10RAILTPModal" role="dialog">
            <div class="modal-dialog modal-lg" style="width:1000px;">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #00aae7;height:50px;">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title" style="color:white;text-align: center;">Top 10 RAIL Trading partners</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
        ...
        <script language="JavaScript"  src='<s:url value="/includes/js/GeneralAjax.js?version=1.2"/>'></script>
