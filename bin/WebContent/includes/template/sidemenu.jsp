...
<!--                                <li id="LBusinessFlow"><a href="<s:url action="../dashboard/getBusinessFlow.action"><s:param name='flag'>L</s:param></s:url>"><i class="fa fa-circle-o"></i>Business Flow View</a></li> 
                               <li id="LEdiDocument"><a href="<s:url action="../dashboard/getEDIDocuments.action"><s:param name='flag'>L</s:param></s:url>"><i class="fa fa-circle-o"></i> EDI Transactional View</a></li>-->
...
<!--                                <li id="MBusinessFlow"><a href="<s:url action="../dashboard/getBusinessFlow.action"><s:param name='flag'>M</s:param></s:url>"><i class="fa fa-circle-o"></i>Business Flow View</a></li> 
                                <li id="MEdiDocument"><a href="<s:url action="../dashboard/getEDIDocuments.action"><s:param name='flag'>M</s:param></s:url>"><i class="fa fa-circle-o"></i> EDI Transactional View</a></li>   -->
                            </ul>
                            </li>
                            <% }%>
